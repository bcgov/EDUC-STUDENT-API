...
ALTER TABLE STUDENT_MERGE
    ADD CONSTRAINT FK_STUDENT_MERGE_STUDENT_ID FOREIGN KEY (STUDENT_ID) REFERENCES STUDENT (STUDENT_ID);

ALTER TABLE STUDENT_MERGE
    ADD CONSTRAINT FK_MERGE_STUDENT_ID FOREIGN KEY (MERGE_STUDENT_ID) REFERENCES STUDENT (STUDENT_ID);

ALTER TABLE STUDENT_MERGE
    ADD CONSTRAINT FK_STUDENT_MERGE_DIRECTION_CODE FOREIGN KEY (STUDENT_MERGE_DIRECTION_CODE) REFERENCES STUDENT_MERGE_DIRECTION_CODE (MERGE_DIRECTION_CODE);

ALTER TABLE STUDENT_MERGE
    ADD CONSTRAINT FK_STUDENT_MERGE_SOURCE_CODE FOREIGN KEY (STUDENT_MERGE_SOURCE_CODE) REFERENCES STUDENT_MERGE_SOURCE_CODE (MERGE_SOURCE_CODE);

ALTER TABLE STUDENT_MERGE
    ADD CONSTRAINT UC_STUDENT_ID_MERGE_STUDENT_ID UNIQUE (STUDENT_ID, MERGE_STUDENT_ID);
...
ALTER TABLE STUDENT_TWIN
    ADD CONSTRAINT FK_STUDENT_TWIN_STUDENT_ID FOREIGN KEY (STUDENT_ID) REFERENCES STUDENT (STUDENT_ID);

ALTER TABLE STUDENT_TWIN
    ADD CONSTRAINT FK_TWIN_STUDENT_ID FOREIGN KEY (TWIN_STUDENT_ID) REFERENCES STUDENT (STUDENT_ID);

ALTER TABLE STUDENT_TWIN
    ADD CONSTRAINT FK_STUDENT_TWIN_REASON_CODE FOREIGN KEY (STUDENT_TWIN_REASON_CODE) REFERENCES STUDENT_TWIN_REASON_CODE (TWIN_REASON_CODE);

ALTER TABLE STUDENT_TWIN
    ADD CONSTRAINT UC_STUDENT_ID_TWIN_STUDENT_ID UNIQUE (STUDENT_ID, TWIN_STUDENT_ID);