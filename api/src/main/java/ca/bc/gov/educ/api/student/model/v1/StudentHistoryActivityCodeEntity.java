...
/**
 * The type Student history activity code entity.
 */
@Getter
@Setter
@Builder
...
@AllArgsConstructor
@Entity
@Table(name = "STUDENT_HISTORY_ACTIVITY_CODE")
public class StudentHistoryActivityCodeEntity {

  /**
   * The History activity code.
   */
  @Id
  @Column(name = "HISTORY_ACTIVITY_CODE", unique = true, updatable = false)
